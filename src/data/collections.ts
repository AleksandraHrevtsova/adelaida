...
export const collections: Record<string, Collection> = {
  ...
  earth: {
    slug: 'earth',
    title: 'Маски колекції EARTH',
    description: '',
    artworks: [
      {
        id: 1,
        title: 'Страж', // Germination / Пророщення
        // title: 'Страж', // Weave / Переплетіння
        // title: 'Страж', // Saturation / Насичення
        // title: 'Страж', // Cover / Покров
        // title: 'Страж', // Mineralization / Мінералізація
        // title: 'Страж', // Merger / Злиття
        // title: 'Страж', // Return / Повернення
        subtitle: '«Кожен перехід вимагає зустрічі з тим, хто охороняє вхід».',
        description:
          'Архетип внутрішнього опору. Ціна трансформації.',
        image: imgUrl,
